...
func (j *jsonCodec) Write(m *codec.Message, b interface{}) error {
	...
	case codec.Publication:
		...
		return err
	default:
		return errors.New(fmt.Sprintln("Unrecognised message type: ", m.Type))
	}
}
...
func (j *jsonCodec) ReadHeader(m *codec.Message, mt codec.MessageType) error {
	...
	case codec.Publication:
		io.Copy(j.buf, j.rwc)
	default:
		return errors.New(fmt.Sprintln("Unrecognised message type: ", mt))
	}
	return nil
}
...
func (j *jsonCodec) ReadBody(b interface{}) error {
	...
	default:
		return errors.New(fmt.Sprintln("Unrecognised message type: ", j.mt))
	}
	return nil
}
