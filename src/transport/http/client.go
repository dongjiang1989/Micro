...
func NewClient(
	...
	c := &Client{
		client:         http.DefaultClient, // http.DefaultClient line:64
		method:         method,
		tgt:            tgt,
		enc:            enc,
		dec:            dec,
...
//If the request implements Headerer, the provided headers will be applied to the request.
func EncodeJSONRequest(c context.Context, r *http.Request, request interface{}) error {
	r.Header.Set("Content-Type", "application/json; charset=utf-8") //default value : set "application/json; charset=utf-8"
